...
cc -arch i386   -DPATH_COMPONENT_TO_APPEND="\"i386\""   -o arch_selector.i386   -Os -framework Foundation -mmacosx-version-min=10.5 arch_selector.m
cc -arch x86_64 -DPATH_COMPONENT_TO_APPEND="\"x86_64\"" -o arch_selector.x86_64 -Os -framework Foundation -mmacosx-version-min=10.5 arch_selector.m
